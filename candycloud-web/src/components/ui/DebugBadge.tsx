...
const entries: { label: string; value: string }[] = [
  ...
  { label: 'VITE_LOGIN_WIDGET_URL', value: import.meta.env.VITE_LOGIN_WIDGET_URL || '(not set)' },
  { label: 'window.origin',  value: typeof window !== 'undefined' ? window.location.origin : '(ssr)' },
]
