...
export const testingCategories: TestingCategory[] = [
    ...
    },
    {
        ...
        group: 'platforms',
        label: 'Android',
        shortLabel: 'Controlled beta',
        summary: 'Phone sign-in, approval and recovery worked in controlled Android tests.',
        scope: 'Rooiam Reference from Play Internal testing on Android 12; broader device and tenant-app coverage remains open.',
        lastTestedOn: '2026-09-25',
        lastTestedAt: '2026-09-25T05:07:15Z',
        rows: [
            { topic: 'QR browser sign-in', result: 'passed', description: 'After the 0.4 server restart, a production QR was scanned and approved; the private browser session entered the workspace.', evidence: '25 Sep · assisted production run · fd4070e' },
            ...
            { topic: 'Approval after app restart', result: 'passed', description: 'A pending phone review returned after force-stop/relaunch, then explicit approval completed sign-in.', evidence: '23 Sep · assisted Android run' },
            ...
            { topic: 'Different-phone replacement', result: 'not-tested', description: 'Recovery was verified on the existing device; replacement with a different device remains unverified.', evidence: 'No replacement-device run' },
        ...
        note: 'These results cover a Play Internal testing package and limited physical-device testing. Broader Android compatibility and a public app release are not yet verified.',
        links: [
    ...
    },
    {
        ...
        rows: [
            ...
            { topic: 'Android Keystore persistence', result: 'passed', description: 'A separate test app passed encrypted storage, tamper rejection and signing after process restart.', evidence: '23 Sep · physical Android 12 device' },
