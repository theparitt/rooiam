...
export default function PortalHelpTooltip({ text }: Props) {
    ...
    return (
        <span className="relative inline-flex items-center">
            ...
            {open && (
                <span className="absolute top-full left-0 mt-2 w-72 rounded-2xl border border-border bg-popover px-3 py-2.5 text-xs font-medium text-popover-foreground shadow-lg z-50 leading-relaxed">
