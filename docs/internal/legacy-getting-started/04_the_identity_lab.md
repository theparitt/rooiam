# Mission 4: The Identity Lab 🧪

**Mission Goal**: Master roles, tenants, and permissions by switching between 15+ pre-seeded characters.
...
### Next Mission:
Did something break? Let's fix it like a pro. 👉 [**Mission 5: Troubleshooting 101**](./05_troubleshooting_101.md)
